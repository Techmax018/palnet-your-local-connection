    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This PalNet page doesn't exist or has been moved.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something went wrong on our end. You can try again or head back to the portal.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PalNet — Local Wi-Fi, Home ISP & TV Billing" },
      {
        name: "description",
        content:
          "PalNet hotspot portal: buy Wi-Fi passes, home internet and TV streaming packages with M-Pesa or a scratch card.",
      },
      { name: "author", content: "PalNet" },
